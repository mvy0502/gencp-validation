...
2. `YOK` ise §3'teki çevrimdışı tekerlek kiti (`kit-win_amd64-py312-2026-08-31` sürümündeki
   `gencp_kit_win_amd64_py312.zip`) ile kurulur ve **QGIS yeniden başlatılır.**
