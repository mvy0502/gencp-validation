...
Mimari ve gerekçe için [eklenti README'si](https://github.com/mvy0502/GenCP/blob/tubitak-tr/tubitak/qgis_plugin/README.md);
ölçüm kayıtları için [confidence-results.md](https://github.com/mvy0502/GenCP/blob/tubitak-tr/tubitak/docs/confidence-results.md) ve
[plugin-field-test.md](https://github.com/mvy0502/GenCP/blob/tubitak-tr/tubitak/docs/plugin-field-test.md).
...
Ayrıntı: [BACKUP.md](https://github.com/mvy0502/GenCP/blob/tubitak-tr/tubitak/docs/evidence/BACKUP.md).
